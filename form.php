...
<body>
    ...
    <h4 class="judul">FORM UPLOAD</h4>
    <form action="sendface.php" method="post" onsubmit="return validate(this)" enctype="multipart/form-data">
    ...
    <p style="font-weight: bold;">Belum punya akun ? Silahkan daftar terlebih dahulu <a href="register.php" style="color:blue">disini</a></p>
    </div>
    </div>
</body>
</html>